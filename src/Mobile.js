...
export default function Mobile() {
    ...
    function Menu() {
        return (
            <>
                ...
                <div className={`flex w-full rounded-b-lg border-t-[1px] border-[${style.colors.lines[0]}]`}>
    ...
    let tabs = [<Menu />, <Hello />]
    return (
        <div className={`w-[100vw] h-[100dvh] flex flex-col rounded-lg bg-[${style.colors.primary[2]}] border-[1px] border-[${style.colors.lines[0]}]`}>
