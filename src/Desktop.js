    ...
    return (
        <div className={`w-[100vw] h-[100vh] flex flex-col rounded-lg bg-[${style.colors.primary[2]}] border-[1px] border-[${style.colors.lines[0]}]`}>
            <header className={`w-full flex justify-between rounded-t-lg border-b-[1px] border-[${style.colors.lines[0]}]`}>
                <div className="flex">
                    <button className={`leading-[${style.leading.label}] text-[${style.font.label}] w-[311px] text-left py-[17px] pl-[22px] border-r-[1px] border-[${style.colors.lines[0]}] text-[${style.colors.secondary[0]}]`}>bawer-my</button>
            ...
            <footer className={`w-full flex justify-between rounded-b-lg border-t-[1px] border-[${style.colors.lines[0]}]`}>
                <div className="flex">
                    ...
                    <SocialLogo onClick={() => window.location.href = "https://github.com"} className={`opacity-40 hover:opacity-100 cursor-pointer px-[14px] py-[11px]`} logo="Twitter" />
                    <div className={`border-r-[1px] border-[${style.colors.lines[0]}]`}></div>
                    <SocialLogo onClick={() => window.location.href = "https://github.com"} className={`opacity-40 hover:opacity-100 cursor-pointer px-[14px] py-[11px]`} logo="Facebook" />
                    <div className={`border-r-[1px] border-[${style.colors.lines[0]}]`}></div>
                </div>
                    <button onClick={() => window.location.href = "https://github.com/BawerMY"} className={`border-l-[1px] border-l-[${style.colors.lines[0]}] text-[${style.colors.secondary[0]}] flex gap-[5px] items-center pl-[23px] pr-[22px]`}><a>@BawerMY</a> <SocialLogo className={`w-[24px] h-[29px]`} logo="Github" /></button>
            </footer>
        </div>
    )
}